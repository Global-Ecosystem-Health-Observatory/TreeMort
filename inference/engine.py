...
def process_image(
    ...
    try:
        ...
        if post_process:
            ...
            refined_centroid_map = refine_centroid_map(segment_map_np, centroid_map_np, threshold=0.2)

            multiple_peaks = detect_multiple_peaks(refined_centroid_map, min_distance=5, threshold_abs=0.1)

            watershed_segmented_map = segment_using_watershed(segment_map_np, refined_centroid_map, multiple_peaks, threshold=conf.threshold)
