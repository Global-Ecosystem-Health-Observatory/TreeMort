...
def build_callbacks(n_batches, output_dir, optimizer, best_model_path="best.weights.transfer.75.pth"):
    ...
    best_checkpoint_cb = ModelCheckpoint(
        os.path.join(output_dir, best_model_path),
        monitor="val_loss",
        mode="min",
        save_best_only=True,
        verbose=1,
    ...
    return [checkpoint_cb, best_checkpoint_cb, early_stop_cb]