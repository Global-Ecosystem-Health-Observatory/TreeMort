...
def trainer(
    ...
    for epoch in tqdm(range(conf.epochs), desc="Epochs", unit="epoch"):
        ...
        if conf.distillation_method == "self":
            ...
            extra_params["use_confidence_weighting"] = str(getattr(conf, "use_confidence_weighting", "True"))
            extra_params["use_fg_bg_weighting"] = str(getattr(conf, "use_fg_bg_weighting", "True"))
